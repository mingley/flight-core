...
- typestate methods generated by `impl_aerial_offboard_now!` (`admit_offboard_now`, `set_velocity_now` / `set_position_now` / `hold_now`; `COMMANDS` is `AERIAL_OFFBOARD_COMMANDS`)

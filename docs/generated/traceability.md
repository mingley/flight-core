...
| FC-INV-004 | Command age `< 100 ms` at actuation | `Timestamp`, `Command`, `Deadline::for_command`, `command_age_ok` | `Requirement::CommandAgeMs` | `dsl_revokes_match_kernel` | GPS_LOSS, `apply_velocity_command_now` |
